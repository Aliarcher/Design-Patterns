""""
    ...
    - a behavioual design pattern that lets you pass requests along a chain of handlers.
    Upon receiving a request, each hnadler decides either to process the request or to pass
    it to the next handler in the chain.
"""

import abc

class AbstracHandler(abc.ABC):
    def set_next(self,handler):
        pass
    def handle(self,request):
        pass

class BaseHandler(AbstracHandler):
    _next_handler = None
