"""
    Command
    - a behavioral design that turns a request into a stand-alone object that
    contains all information about th request. This transformation lets you pass requests
...
class ComplexCommand(Command):
    def __init__(self,receiver,a,b):
        ...
        self._b = b
    def execute(self):
        print('ComplexCommand: Complex stuff should be done by receiver object',end='')
        self._receiver.do_something(self._a)
        self._receiver.do_something(self._b)  

class Receiver:
    def do_something(self,a):
        print(f'\nReciver: working on ({a}.)', end="")
    def do_something_else(self,b):
        print(f'\nReciver: working on ({b}.)',end="")    
